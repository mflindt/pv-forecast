...
from pvforecast.config import INTERIM_DIR, RAW_DIR
...
def main():
    """Build the clean hourly PV series from raw data and save it to data/interim."""
    raw_path = RAW_DIR / "smard_pv_realized_quarterhour_2015-2026.csv"
    df = build_hourly_series(raw_path, START, END)

    INTERIM_DIR.mkdir(parents=True, exist_ok=True)
    out_path = INTERIM_DIR / "pv_hourly.parquet"
